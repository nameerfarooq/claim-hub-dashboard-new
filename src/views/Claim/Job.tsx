    ...
    const tableData = [
        {
            ...
            status: 'In Progress',
            stage: 'Jobs',
            subStage: 'Prep', // Updated to one of the specified values
        ...
        },
        {
            ...
            status: 'Closed',
            stage: 'Jobs',
            subStage: 'Perform', // Updated to one of the specified values
        ...
        },
        {
            ...
            status: 'In Progress',
            stage: 'Jobs',
            subStage: 'Compliance', // Updated to one of the specified values
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <Tag
                className={` ${
                    row.original.subStage === 'Perform'
                        ? 'bg-sky-100'
                        : row.original.subStage === 'Compliance'
                          ? 'bg-red-100'
        ...
        <main className="bg-white p-4 rounded-2xl border border-gray-200 h-full flex flex-col gap-[20px]">
            <div className="flex flex-row flex-wrap gap-[10px] justify-between">
                ...
                <div className="flex flex-row gap-[10px]">
                    ...
                    <button className="text-nowrap flex items-center gap-2 border border-primary rounded-xl px-4 py-2 text-sm font-bold text-white bg-primary hover:bg-primary-deep">
                        <span>
                            <AddUserIcon />
                        </span>
                        Add new
