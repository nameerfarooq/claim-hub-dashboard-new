...
const Accounting = () => {
    const tableData = [
        ...
        },
        {
            ...
            status: 'In Progress',
            stage: 'Accounting',
            subStage: 'Public Adjuster Compliance',
        ...
        },
        {
            ...
            status: 'Follow-Up',
            stage: 'Accounting',
            subStage: 'Desk Adjuster Assigned',
            lastUpdated: '2024-07-01',
            pa: 'Sophia Rivera',
        },
        {
